      ...
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:anandtrifitness@gmail.com" className="hover:text-white transition-colors">
                    anandtrifitness@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4" />
                  <a href="tel:+91-8296102292" className="hover:text-white transition-colors">
                    +91-8296102292
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>Made by Anand Mahadev - Powered by V0</p>
          </div>
        </div>
      </div>
    </footer>
